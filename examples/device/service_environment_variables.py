...
async def main() -> None:
    ...
    async with BalenaCloud(token="") as client:
        ...
        print("================================================")
        env_variables = await client.device_service_variable.get_all(
            device_id=device_id
        )
        print(env_variables)
        ...
        print("=======================================")
        env_variable = await client.device_service_variable.get(
        ...
        print()
        print("Update a service environment variable from a device")
        print("===================================================")
        await client.device_service_variable.update(
        ...
        print()
        print("Delete a service environment variable from a device")
        print("===================================================")
        await client.device_service_variable.remove(variable_id=env_variables[0].id)
        env_variables = await client.device_service_variable.get_all(
            device_id=device_id
        )
        print(env_variables)
